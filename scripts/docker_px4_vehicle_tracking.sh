 #! /bin/bash
# Running Docker file for ROS Melodic and PX4 10.1 and mavros_apriltag_tracking package
# Authors: Mohammed Abdelkader
 
DOCKER_REPO="mzahana/px4_vehicle_tracking:latest"
CONTAINER_NAME="vehicle_tracking"
